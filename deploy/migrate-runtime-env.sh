...
ensure_var CLICTOPAY_MODE disabled
ensure_var CLICTOPAY_ADAPTER_CERTIFIED false
ensure_var CLICTOPAY_MERCHANT_ID ""
ensure_var CLICTOPAY_API_URL ""
ensure_var CLICTOPAY_API_SECRET ""
ensure_var CLICTOPAY_ALLOWED_REDIRECT_HOSTS ""
ensure_var STAGING_CLICTOPAY_MODE disabled
ensure_var STAGING_CLICTOPAY_ADAPTER_CERTIFIED false
ensure_var STAGING_CLICTOPAY_MERCHANT_ID ""
ensure_var STAGING_CLICTOPAY_API_URL ""
ensure_var STAGING_CLICTOPAY_API_SECRET ""
ensure_var STAGING_CLICTOPAY_ALLOWED_REDIRECT_HOSTS ""
