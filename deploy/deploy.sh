...
case "$TARGET" in
  staging)
    ...
    services=(staging-db staging-valkey staging-app staging-email-worker staging-content-worker)
  ...
  production)
    ...
    services=(prod-db prod-valkey prod-app prod-email-worker prod-content-worker)
