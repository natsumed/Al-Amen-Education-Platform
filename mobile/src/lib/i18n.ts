...
const dict = {
  ...
  locked: {
    fr: "Contenu premium — abonnement ou achat permanent",
    ar: "محتوى مميز — اشتراك أو شراء دائم",
  },
  ...
  parentNoCourses: {
    fr: "Les cours sont sur le compte élève. Ici : suivi et paiement sécurisé.",
    ar: "الدروس على حساب التلميذ. هنا المتابعة والدفع الآمن.",
  },
  ...
  payOnWeb: { fr: "Payer pour un enfant", ar: "الدفع لطفل" },
